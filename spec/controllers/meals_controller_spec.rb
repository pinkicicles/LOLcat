  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved meal as @meal" do
        ...
        post :create, {:meal => { "name" => "invalid value" }}, valid_session
        assigns(:meal).should be_a_new(Meal)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested meal" do
        ...
        Meal.any_instance.should_receive(:update_attributes).with({ "name" => "MyString" })
        put :update, {:id => meal.to_param, :meal => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the meal as @meal" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Meal.any_instance.stub(:save).and_return(false)
        put :update, {:id => meal.to_param, :meal => { "name" => "invalid value" }}, valid_session
        assigns(:meal).should eq(meal)
      end

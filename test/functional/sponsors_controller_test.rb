...
class SponsorsControllerTest < ActionController::TestCase
  ...
  test "should create sponsor" do
    assert_difference('Sponsor.count') do
      post :create, sponsor: { Company: @sponsor.Company, Donation: @sponsor.Donation, Email: @sponsor.Email, Name: @sponsor.Name }
    end
  ...
  test "should update sponsor" do
    put :update, id: @sponsor, sponsor: { Company: @sponsor.Company, Donation: @sponsor.Donation, Email: @sponsor.Email, Name: @sponsor.Name }
    assert_redirected_to sponsor_path(assigns(:sponsor))
  end
